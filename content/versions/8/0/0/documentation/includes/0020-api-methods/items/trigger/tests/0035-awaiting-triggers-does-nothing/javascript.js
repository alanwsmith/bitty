window.ClassD9638 = class {
  ...
  async bittyReady() {
    ...
    //////////////////////////////////////////////
    await this.api.trigger("await:test_signal_D9638");
    this.api.trigger("verify_signal_D9638");
    //////////////////////////////////////////////
  ...
  async test_signal_D9638(_, el) {
    await this.api.sleep(50);
  }

  verify_signal_D9638(_, el) {
