const baseParams = {
  ...
  "font-size": {
    ...
    values: [
      ...
      "clamp(0.68rem, calc(0.67rem + 0.03vw), 0.8rem)",
      "clamp(0.78rem, calc(0.97rem + 0.06vw), 1.05rem)",
      "clamp(0.94rem, calc(1.2rem + 0.11vw), 1.2rem)",
      "clamp(1.08rem, calc(1.20rem + 0.22vw), 1.29rem)",
      "clamp(1.35rem, calc(1.28rem + 0.37vw), 1.56rem)",
      "clamp(1.32rem, calc(1.5rem + 0.58vw), 1.67rem)",
      "clamp(1.84rem, calc(1.77rem + 0.87vw), 2.14rem)",
      "clamp(2.8rem, calc(2.4rem + 1.25vw), 3.1rem)",
    ],
  },
  ...
  "width": {
    ...
    varString: `--SIZE-KEY: VALUE;`,
    values: [
      "min(100vw - 1.4rem, 6rem)",
      "min(100vw - 1.4rem, 15rem)",
      "min(100vw - 1.4rem, 32rem)",
      "min(100vw - 1.4rem, 38rem)",
      "min(100vw - 1.4rem, 44rem)",
