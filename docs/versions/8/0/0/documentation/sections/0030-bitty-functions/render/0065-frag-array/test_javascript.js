...
newEl.innerHTML = "TARGET_signal_B15F2";
...
subFragment2.innerHTML = "<div>signal_B15F2</div>";

const subs = {
  "TARGET_signal_B15F2": [subFragment1.content, subFragment2.content],
};

export function signal_B15F2(ev, sender, el) {
